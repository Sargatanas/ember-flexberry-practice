...
namespace IIS.Shop
{
    ...
    public class Employee : ICSSoft.STORMNET.DataObject
    {
        ...
        /// PhoneNumer.
        /// </summary>
        // *** Start programmer edit section *** (Employee.PhoneNumer CustomAttributes)

        // *** End programmer edit section *** (Employee.PhoneNumer CustomAttributes)
        [StrLen(255)]
        public virtual string PhoneNumer
        {
            get
            {
                // *** Start programmer edit section *** (Employee.PhoneNumer Get start)

                // *** End programmer edit section *** (Employee.PhoneNumer Get start)
                string result = this.fPhoneNumer;
                // *** Start programmer edit section *** (Employee.PhoneNumer Get end)

                // *** End programmer edit section *** (Employee.PhoneNumer Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Employee.PhoneNumer Set start)

                // *** End programmer edit section *** (Employee.PhoneNumer Set start)
                this.fPhoneNumer = value;
                // *** Start programmer edit section *** (Employee.PhoneNumer Set end)

                // *** End programmer edit section *** (Employee.PhoneNumer Set end)
            }
        }
