...
namespace IIS.Shop
{
    ...
    [AssociatedDetailViewAttribute("OrderE", "OrderString", "OrderStringE", true, "", "Содержимое заказа", true, new string[] {
            ""})]
    ...
    public class Order : IIS.Shop.Document
    {
        ...
        private IIS.Shop.DetailArrayOfOrderString fOrderString;
        ...
        /// Заказ.
        /// </summary>
        // *** Start programmer edit section *** (Order.OrderString CustomAttributes)

        // *** End programmer edit section *** (Order.OrderString CustomAttributes)
        public virtual IIS.Shop.DetailArrayOfOrderString OrderString
        {
            get
            {
                // *** Start programmer edit section *** (Order.OrderString Get start)

                // *** End programmer edit section *** (Order.OrderString Get start)
                if ((this.fOrderString == null))
                {
                    this.fOrderString = new IIS.Shop.DetailArrayOfOrderString(this);
                }
                IIS.Shop.DetailArrayOfOrderString result = this.fOrderString;
                // *** Start programmer edit section *** (Order.OrderString Get end)

                // *** End programmer edit section *** (Order.OrderString Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Order.OrderString Set start)

                // *** End programmer edit section *** (Order.OrderString Set start)
                this.fOrderString = value;
                // *** Start programmer edit section *** (Order.OrderString Set end)

                // *** End programmer edit section *** (Order.OrderString Set end)
            }
        }
