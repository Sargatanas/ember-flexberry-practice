...
namespace IIS.Shop
{
    ...
    [AssociatedDetailViewAttribute("InvoiceE", "InvoiceString", "InvoiceStringE", true, "", "Список товаров к выдаче", true, new string[] {
            ""})]
    ...
    public class Invoice : IIS.Shop.Document
    {
        ...
        private IIS.Shop.DetailArrayOfInvoiceString fInvoiceString;
        ...
        /// Накладная.
        /// </summary>
        // *** Start programmer edit section *** (Invoice.InvoiceString CustomAttributes)

        // *** End programmer edit section *** (Invoice.InvoiceString CustomAttributes)
        public virtual IIS.Shop.DetailArrayOfInvoiceString InvoiceString
        {
            get
            {
                // *** Start programmer edit section *** (Invoice.InvoiceString Get start)

                // *** End programmer edit section *** (Invoice.InvoiceString Get start)
                if ((this.fInvoiceString == null))
                {
                    this.fInvoiceString = new IIS.Shop.DetailArrayOfInvoiceString(this);
                }
                IIS.Shop.DetailArrayOfInvoiceString result = this.fInvoiceString;
                // *** Start programmer edit section *** (Invoice.InvoiceString Get end)

                // *** End programmer edit section *** (Invoice.InvoiceString Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Invoice.InvoiceString Set start)

                // *** End programmer edit section *** (Invoice.InvoiceString Set start)
                this.fInvoiceString = value;
                // *** Start programmer edit section *** (Invoice.InvoiceString Set end)

                // *** End programmer edit section *** (Invoice.InvoiceString Set end)
            }
        }
